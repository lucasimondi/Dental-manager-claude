...
export default function Piani({ patients, plans, setPlans, payments = [], pricelist, templates, si, features, initPatId, onClearInitPat, onOpenPaz, autoOpenNew, onAutoOpenNewHandled }) {
