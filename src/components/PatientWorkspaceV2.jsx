...
const primaryActions = (status) => status === 'Eseguita'
  ...
  : status === 'In corso'
    ? ['Programma', 'Segna eseguita']
    : status === 'Richiamo da programmare'
      ? ['Programma', 'Modifica']
      : ['Programma', 'Segna in corso'];
