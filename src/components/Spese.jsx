...
export default function Spese({ refreshKey, studioId, patients = [], mostraUpload = true, autoOpenNew, onAutoOpenNewHandled } = {}) {
  ...
  const openNuova = () => { setEditItem(null); setModal(true); };
  ...
  return (
    <div>
      ...
      {/* MODAL NUOVA/MODIFICA SPESA — condiviso con l'azione veloce "Spesa"
          nella scheda paziente (SpesaModal.jsx), mai due implementazioni. */}
      {modal && (
        <SpesaModal
          editItem={editItem}
          patients={patients}
          ...
          onSalvato={() => { setModal(false); loadSpese(); setToast(editItem ? 'Aggiornata ✓' : 'Aggiunta ✓'); }}
        />
      )}
