...
export default function Pazienti({ patients, setPatients, plans, setPlans, payments, setPayments, appointments, setAppointments, si, features, studioMembership, onNuovoPiano, implants, setImplants, onNuovoAppuntamento, templates, pricelist }) {
  ...
  if (scheda) {
    return (
      <SchedaPaz
        ...
        si={si} features={features} studioMembership={studioMembership} implants={implants} setImplants={setImplants} pricelist={pricelist}
