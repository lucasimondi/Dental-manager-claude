...
export default function Pazienti({ patients, setPatients, plans, setPlans, payments, appointments, setAppointments, si, onNuovoPiano, implants, setImplants, onNuovoAppuntamento, templates }) {
