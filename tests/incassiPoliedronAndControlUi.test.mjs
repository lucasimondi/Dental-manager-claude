...
test('Poliedron default Naviga includes the real Incassi section', () => {
...
test('management control uses module cards instead of the compressed tabbar', () => {
  assert.match(control, /management-hub__modules/);
