...
- Exact next action: Product Owner reviews the merged result. Remote migration/deployment remains a separate explicit gate; do not apply the migration, backfill, modify production data or trigger a manual deploy without that authorization.
