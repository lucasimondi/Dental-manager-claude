...
- COMMIT: recorded by the commit containing this handoff.
- Exact next action: Product Owner reviews the Chat Polyedron PR and migration/RLS contract. Do not merge, deploy, or apply the migration remotely without explicit Product Owner approval. Status: `WAITING_PRODUCT_OWNER`.
