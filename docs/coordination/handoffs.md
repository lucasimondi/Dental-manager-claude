...
- Exact next action: commit/push, open PR to `master`, wait for required checks, review final GitHub diff, and merge only if green and mergeable under the Product Owner's explicit code-merge authorization. Do not apply the migration or deploy.
