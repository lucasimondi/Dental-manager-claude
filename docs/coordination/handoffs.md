...
- PR: #83, aperta verso `master` dopo commit `120d690`.
- Exact next action: wait for PR #83 required checks, review the final GitHub diff, and merge only if green and mergeable under the Product Owner's explicit code-merge authorization. Do not apply the migration or deploy.
