...
- EXACT NEXT ACTION: in attesa di "Mergia" esplicita del Product Owner — dato che questo è il vero fix (i tre giri precedenti erano infrastruttura utile ma non la causa), il popup dovrebbe finalmente funzionare non appena questo è online.
