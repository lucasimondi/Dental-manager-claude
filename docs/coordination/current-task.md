...
- STATUS: IN CORSO — implementato, testato, buildato; branch pushato; in attesa di "Mergia" esplicito del Product Owner prima di aprire la PR.
...
- EXACT NEXT ACTION: in attesa della risposta del Product Owner sulla proposta di ordinamento/evidenziazione sopra, e in attesa che dica "Mergia" — poi: push del branch (già fatto), apertura PR, merge.
