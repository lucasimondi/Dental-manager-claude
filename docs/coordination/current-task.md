...
- STATUS: MERGED (PR #71, merge commit `070b28f`) — Product Owner confirmed on a real phone that Apri/Stampa now works in the patient record's Documenti tab.
...
- EXACT NEXT ACTION: none — task closed. Next task, if any, should be recorded above this entry.
